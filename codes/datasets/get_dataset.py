import argparse
from codes.datasets.base import Dataset
from codes.datasets.generation import get_dataset
...
def dataset(folder,
    ...
    if generation:
        ...
        dataset = "CELEBA"
        args = {"exp": "/home/liu/disk12t/liu_data/disk12_2_link/disk12_2/dataset/diffusion_dataset"}
    else:
        dataset_import = "base"
