...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', '-p', type=str,
                        default='/home/solid/super_resolution/model/Diffusion/RDDM_TTSR_论文/消融实验/306_TTRD3_transformer_实验/data/MFAM特征图/split512_256'.format(
                            Path.home()))
    parser.add_argument('--out', '-o', type=str,
                        default='/home/solid/super_resolution/model/Diffusion/RDDM_TTSR_论文/消融实验/306_TTRD3_transformer_实验/data/MFAM特征图/split')
