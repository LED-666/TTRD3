...
def main():
    ...
    if dataset == 'val_1st':
        ...
        data_path = '/home/solid/super_resolution/datasets/AID/AID_64_256_dataset_plus/val_64_256/'
        lmdb_path = '/home/solid/super_resolution/datasets/AID/AID_lmdb/val/'
        fold_list = glob.glob('/home/solid/super_resolution/datasets/AID/AID_64_256_dataset_plus/val_64_256/*')
        util.mkdir_and_rename(lmdb_path)
        print(fold_list)
        for path in fold_list:
            base_name = osp.basename(path)
